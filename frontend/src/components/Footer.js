      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              La plateforme de covoiturage qui met l'écologie au cœur du transport.
              Partagez vos trajets, réduisez votre empreinte carbone et économisez !
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-300 hover:text-eco transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/search" className="text-gray-300 hover:text-eco transition-colors">
                  Rechercher un trajet
                </Link>
              </li>
              <li>
                <Link to="/create-trip" className="text-gray-300 hover:text-eco transition-colors">
                  Publier un trajet
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4 mt-4 md:mt-0">
            <span className="text-sm text-gray-300">Fait avec 💚 pour la planète</span>
          </div>
        </div>
      </div>
    </footer>
